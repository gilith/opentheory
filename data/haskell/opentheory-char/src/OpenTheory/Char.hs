...
newtype Char = Char { unChar :: Natural.Natural }
...
plane :: Char -> Natural.Natural
plane = destPlane . unChar

position :: Char -> Natural.Natural
position = destPosition . unChar
